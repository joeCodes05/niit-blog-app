  ...
  return (
    <>
      {type === 'password' ? <div className='outline-none rounded-md overflow-hidden bg-secondary ring-1 ring-gray-700 flex gap-2 items-center'>
        <input type={seePassword ? 'text' : 'password'} className='p-2 outline-none text-white bg-transparent box-border w-full' placeholder={placeholder} value={value} onChange={onChange} required />
